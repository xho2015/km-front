var AppGa4Ma2 = (function() {
	
	function init() {
        ART.init();
        
        ART.code("text", "'t11', '80.4'");
        ART.code("align", "200, 120, 't11'");
        ART.code("sleep", "1000");

        ART.code("text", "'t12', '+'");
        ART.code("align", "340, 120, 't12'");
        ART.code("sleep", "1000");

        ART.code("text", "'t13', '78.8'"); 
        ART.code("align", "380, 120, 't13'");
        ART.code("sleep", "1000");

        ART.code("text", "'t14', '+'");
        ART.code("align", "520, 120, 't14'");
        ART.code("sleep", "1000");

        ART.code("text", "'t15', '80.8'");
        ...
        ART.code("text", "'t22', '+'");
        ART.code("align", "490, 200, 't22'");
        ART.code("sleep", "1000");

        ART.code("text", "'t250', '('");
        ART.code("text", "'t251', '80'");
        ART.code("text", "'t252', ' - '");
        ART.code("text", "'t253', '1.2'");
        ART.code("text", "'t254', ')'");
        ART.code("align", "530, 200, 't250','t251','t252','t253','t254'");
        ART.code("sleep", "1000");
        ART.code("shine", "500, 'red','t13', 't251','t252','t253'");
        ART.code("sleep", "200"); 

        ART.code("text", "'t26', '+'");
        ART.code("align", "800, 200, 't26'");
        ART.code("sleep", "1000");
        
        ART.code("text", "'t270', '('");
        ART.code("text", "'t271', '80'");
        ART.code("text", "'t272', ' + '");
        ART.code("text", "'t273', '0.8'");
        ART.code("text", "'t274', ')'");
        ART.code("align", "850, 200, 't270', 't271', 't272', 't273', 't274'");
        ART.code("sleep", "1000");
        ...
        ART.code("changeText", "'t251c', '80 X 2'");
        ...
        ART.code("changeText", "'t271c', '80 x 3'");
        ART.code("destroy", "'t251c'"); 

        ART.code("sleep", "1000"); 
        ART.code("text", "'t31', ' + '");
        ART.code("align", "360, 280, 't31'");
        ART.code("sleep", "1000"); 
